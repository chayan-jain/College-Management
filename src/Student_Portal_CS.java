 ...
 * @author dell
 */
public class Student_Portal_CS extends javax.swing.JFrame {
Statement st=null;
ResultSet rs=null;
    /**
     * Creates new form Grades
     */
    public Student_Portal_CS() {
        initComponents();
    }
...
if(rb4.isSelected())
{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Student_Portal_CS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Student_Portal_CS().setVisible(true);
            }
        });
    }
